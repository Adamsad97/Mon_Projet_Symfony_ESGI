...
class Playlist
{
     ...
     */
    #[ORM\OneToMany(targetEntity: PlaylistSubscription::class, mappedBy: 'playlistId', orphanRemoval: true)]
    private Collection $playlistSubscriptions;

    /**
     * @var Collection<int, PlaylistMedia>
     */
    #[ORM\OneToMany(targetEntity: PlaylistMedia::class, mappedBy: 'playlistId', orphanRemoval: true)]
